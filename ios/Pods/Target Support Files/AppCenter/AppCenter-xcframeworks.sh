...
install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterAnalytics.xcframework" "AppCenterAnalytics" "framework" "ios-arm64_x86_64-maccatalyst/AppCenterAnalytics.framework" "ios-arm64_arm64e_armv7_armv7s/AppCenterAnalytics.framework" "ios-arm64_i386_x86_64-simulator/AppCenterAnalytics.framework"
...
install_xcframework "${PODS_ROOT}/AppCenter/AppCenter-SDK-Apple/AppCenterCrashes.xcframework" "AppCenterCrashes" "framework" "ios-arm64_arm64e_armv7_armv7s/AppCenterCrashes.framework" "ios-arm64_x86_64-maccatalyst/AppCenterCrashes.framework" "ios-arm64_i386_x86_64-simulator/AppCenterCrashes.framework"
